// modules/mod-treasure/src/autoupdate.cpp
...
// ---------- WorldScript ----------
class Treasure_Customs_UpdaterWS : public WorldScript
{
public:
    Treasure_Customs_UpdaterWS()
        : WorldScript("Treasure_Customs_UpdaterWS", std::vector<uint16>{ WORLDHOOK_ON_AFTER_CONFIG_LOAD, WORLDHOOK_ON_STARTUP }) {}
    ...
    void OnStartup() override
    {
        ...
        LOG_INFO("gv.customs", "┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
        LOG_INFO("gv.customs", "┃ Treasure – Customs SQL Updater ┃");
        LOG_INFO("gv.customs", "┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
...
{
    new Treasure_Customs_UpdaterWS();
}
